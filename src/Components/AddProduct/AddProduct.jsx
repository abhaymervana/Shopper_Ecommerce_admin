...
const AddProduct = () => {
  ...
  const AddProduct = async () => {
    ...
    await fetch('https://abhay-ecommerce-backend-85fd8def7f10.herokuapp.com/upload', {
      method: 'POST',
      headers: {
    ...
    if (dataObj.success) {
      ...
      console.log(product);
      await fetch('https://abhay-ecommerce-backend-85fd8def7f10.herokuapp.com/addproduct', {
      method: 'POST',
      headers: {
        Accept:'application/json',
